...
export default function StarRating({ starCount }) {
    const maxNumber = 5;
    const ratingRowStyle = { display: 'inline-flex', alignItems: 'center' };
    const starsStyle = { display: 'inline-flex', whiteSpace: 'nowrap', flexShrink: 0 };
    const ratingTextStyle = { display: 'inline-block', marginLeft: '0.5rem', whiteSpace: 'nowrap', flexShrink: 0 };
    return (
